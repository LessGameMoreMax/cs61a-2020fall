...
def swine_align(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4a
    "*** YOUR CODE HERE ***"
    m = min(player_score, opponent_score)
    if m < 10:
        return False
    while m != 9:
        if player_score % m == 0 and opponent_score % m == 0:
            return True
        m -= 1
    return False
    # END PROBLEM 4a
...
def pig_pass(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4b
    "*** YOUR CODE HERE ***"
    if player_score < opponent_score and \
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        if who == 0:
            ...
            score = score1
        if score - last_score > m_r_h:
            m_r_h = score - last_score
            print(m_r_h, "point(s)! The most yet for Player", who)
        return announce_highest(who, score, m_r_h)
    return say 
    # END PROBLEM 7
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    if score - GOAL_SCORE <= 3:
        return 1
    if score - GOAL_SCORE <= 6:
        return 2
    if score - GOAL_SCORE <= 9:
        return 3
